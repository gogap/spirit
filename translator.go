...
type NewInputTranslatorFunc func(options Options) (translator InputTranslator, err error)
type NewOutputTranslatorFunc func(options Options) (translator OutputTranslator, err error)
