...
func TestRouteToHandler(t *testing.T) {
	...
	if translator, err = lines.NewLinesInputTranslator(spirit.Map{"bind_urn": "test@urn:spirit:component:encoding:base64#encode"}); err != nil {
	...
	if router, err = NewClassicRouter(spirit.Map{}); err != nil {
		t.Errorf("create router error: %s", err.Error())
		return
	}

	var component spirit.Component
	if component, err = base64.NewBase64Component(spirit.Map{}); err != nil {
