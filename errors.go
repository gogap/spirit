...
var (
	...
	ERR_CONFIG_FILE_NOT_CACHED         = errors.TN(SPIRIT_ERR_NS, 53, "config file of {{.fileName}} not cached")
	ERR_CONFIG_ALREADY_LOADED          = errors.TN(SPIRIT_ERR_NS, 54, "config file already loaded, but did not have same md5: {{.fileName}}")
	...
	ERR_CACHE_CONFIG_BACKUP_FAILED     = errors.TN(SPIRIT_ERR_NS, 57, "backup cache config failed, file: {{.fileName}}, err: {{.err}}")
