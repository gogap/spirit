...
var (
	...
	ERR_PORT_NAME_IS_EMPTY    = errors.TN(SPIRIT_ERR_NS, 22, "port name is empty, component: {{.name}}")
	ERR_HANDLER_NAME_IS_EMPTY = errors.TN(SPIRIT_ERR_NS, 23, "handler name is empty, component: {{.name}}")
)
